...
import { GrSubtract  } from 'react-icons/gr'; // 대신 사용해볼 아이콘
...
import { deletButton, header, listWrapper, name } from './List.css'
...
const List: FC<TListProps> = ({
  ...
  const hanbleListDelete = (listId: string) => {
